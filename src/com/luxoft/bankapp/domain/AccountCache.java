...
public class AccountCache {
    private static final Map<String, AbstractAccount> accounts = new HashMap<>() {{
        put(AccountType.CHECKING.name(), (AbstractAccount) AccountFactory.createNewAccount(
                AccountType.CHECKING, 0, 0));
        put(AccountType.SAVING.name(), (AbstractAccount) AccountFactory.createNewAccount(
